...
export default function CitizenshipForm({ formData, updateFormData, step, setStep, handleSubmit }) {
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              {t("application.fullName")} {t("application.fullNameNote")} *
            </label>
            <Input
            ...
            <p className="text-xs text-gray-500 mt-1">
              {t("application.fullNameNoteText")}
            </p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => updateFormData('chineseName', e.target.value)}
            placeholder={t("application.chineseNamePlaceholder")}
          />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
        ...
        <div>
          ...
          <Input
            value={formData.nric}
            onChange={(e) => updateFormData('nric', e.target.value)}
            placeholder={t("application.nricPlaceholder")}
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
  ...
  if (step === 4) {
    return (
      <div className="space-y-4 md:space-y-6">
        <div className="bg-brand-navy-50 p-3 md:p-4 rounded-lg border border-brand-navy-200 mb-4">
  ...
  if (step === 5) {
    return (
      <div className="space-y-4 md:space-y-6">
        <div className="bg-gray-50 p-3 md:p-4 rounded-lg border border-gray-200 mb-4">
          <p className="text-xs md:text-sm font-semibold text-gray-900 mb-2">
            {t("application.declarationTitle") || "I declare that:"}
          </p>
          <div className="text-xs md:text-sm text-gray-700 space-y-2 whitespace-pre-line break-words">
            <p>
